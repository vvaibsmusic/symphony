...
export default function YouTubeDashboard() {
    ...
    const hot = filteredSongs.slice(0, 100).map(v => ({
        ...
        mult: v.growth_factor ? `${v.growth_factor.toFixed(2)}x` : "0.00",
        from: formatNumber(v.previous_count || 0),
        to: formatNumber(v.current_count || v.current_views || 0),
    ...
    const fresh = releases.slice(0, 100).map(r => ({
        id: r.artist_id,
        song_id: r.song_id,
