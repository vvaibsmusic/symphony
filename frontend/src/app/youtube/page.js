                                ...
                                <tr>
                                    {["#", "Artist", "Genre", "Region", "Songs", "Total Views", "Latest Release", ""].map((h, i) => (
                                        <th key={i} style={{
                                            ...
                                            borderBottom: "1px solid var(--border-subtle)", background: "var(--bg-secondary)", whiteSpace: "nowrap"
                                        }}>{h}</th>
                                    ))}
                                </tr>
                            )}
                                ...
                                return (
                                    <>
                                        ...
                                        <td style={{
                                            ...
                                            fontSize: rank <= 3 ? "1rem" : "0.85rem", borderBottom: "1px solid var(--border-subtle)"
                                        }}>
                                            {rank <= 3 ? ["🥇", "🥈", "🥉"][rank - 1] : rank}
                                        </td>
                                        ...
                                        {/* Songs */}
                                        <td style={{ padding: "10px 12px", textAlign: "right", fontVariantNumeric: "tabular-nums", color: "var(--text-primary)", borderBottom: "1px solid var(--border-subtle)" }}>
                                            {a.yt_song_count || 0}
                                        </td>

                                        {/* Views */}
                                        <td style={{ padding: "10px 12px", textAlign: "right", fontWeight: 600, fontVariantNumeric: "tabular-nums", color: a.total_yt_views ? "var(--text-primary)" : "var(--text-muted)", borderBottom: "1px solid var(--border-subtle)" }}>
